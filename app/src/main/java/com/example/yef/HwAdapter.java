...
class HwAdapter extends BaseAdapter {
    ...
    public void setEventView(View v, int pos, TextView txt){
        ...
        for (int i = 0; i < len; i++) {
            ...
            String date=cal_obj.start_date;
...
/*    public void getPositionList(String date, final Activity act){
        ...
        for (int j=0; j<len; j++){
            if (HomeCollection.date_collection_arr.get(j).start_date.equals(date)){
                HashMap<String, String> maplist = new HashMap<String, String>();
                maplist.put("hnames",HomeCollection.date_collection_arr.get(j).eventname);
